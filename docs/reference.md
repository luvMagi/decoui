# decoui — Complete Reference

> [Project README](../README.md)

This page preserves the complete API and behaviour reference. For a concise
project introduction, start with the [README](../README.md). Task-oriented
guides are linked from the relevant sections below.

![decoui application preview](images/preview.png)
...
> Full guide: [startup-lifecycle.md](startup-lifecycle.md) — read it before loading anything at startup.
...
> [cancelling-a-run.md](cancelling-a-run.md).
...
> Full reference: [help-authoring.md](help-authoring.md).
...
> [translating-an-application.md](translating-an-application.md).
